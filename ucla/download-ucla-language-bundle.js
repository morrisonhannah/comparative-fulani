...
// return data from the (only) table in a url
...
// for metadata table: 
// <td>header:</td><td>value</td>
// http://archive.phonetics.ucla.edu/Language/ABQ/abq_record_details.html
let parseMetadataTable = table => Array.from(table.rows)
  .reduce((o, row) => {
